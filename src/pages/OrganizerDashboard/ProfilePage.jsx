...
const ProfilePage = () => {
        // Load from localStorage if available
            ...
            const [userName, setUserName] = useState(() => localStorage.getItem('profileName') || "Organizer Miller");
            const [userEmail, setUserEmail] = useState(() => localStorage.getItem('profileEmail') || "alex.miller@gmail.com");
